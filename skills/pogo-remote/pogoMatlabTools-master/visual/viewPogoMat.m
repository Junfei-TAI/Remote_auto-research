function  [ ] = viewPogoMat( m, matNum, npix, plane, offset )
% viewPogoMat - view material data from Pogo in 2D or 3D
%   viewPogoMat( m, matNum, npix, plane, offset )
%
...
%       if matNum == -1, just plot the material type number
...
%Updated to allow matNum = -1, Aug 2020
