function  [ ] = viewPogoProperty( m, elVals, npix, plane, offset )
% viewPogoProperty - view a property from Pogo in 2D or 3D
%   viewPogoProperty( m, elVals, npix, plane, offset )
%
...
%elVals - what is the property to be plotted, for each of the elements
...
%
%Written Nov 18th 2023 - P. Huthwaite
...
elVals = elVals(:);
if length(elVals) ~= nEls
    error("elVals incorrect length for this model")
end
